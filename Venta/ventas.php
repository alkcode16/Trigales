...
function hora(){
		...
		horaProgramada.setMinutes(13);
		horaProgramada.setSeconds(10);
...
function ejecutar(){
    ...
    <br>
		<div>
      <a class="btn btn-warning" href="../Reportes/notaMostrador.php">Mostrar La Nota Generada</a>
      ...
      <a class="btn btn-success" href="./redireccionar.php">Nueva Venta De Mostrador</a>
