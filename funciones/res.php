<?php
    ...
    $db_host = 'localhost'; //Host del Servidor MySQL
  	$db_name = 'pasteleria'; //Nombre de la Base de datos
	...
	//$salida_sql = $basededatos.'_'.$fecha.'.sql';
  $salida_sql = $db_name.'_'.$fecha.'.sql';
	//Comando para genera respaldo de MySQL, enviamos las variales de conexion y el destino
  $dump = "mysqldump -u ".$db_user."-p ".$db_name."> $salida_sql";
	//$dump = "mysqldump --h$host -u$usuariodb -p$clavedb --opt $basededatos > $salida_sql";
	...
	//$salida_zip = $basededatos.'_'.$fecha.'.zip';
