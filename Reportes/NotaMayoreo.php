...
foreach($_SESSION["carrito"] as $indice => $producto){
      ...
      //precio parcial
      $caracter="$producto->p_mayoreo";
      if (substr($producto->p_mayoreo, -3)==".00") {

      }else {

          if (substr($caracter, -2)==".5"){
            $producto->p_mayoreo=$producto->p_mayoreo."0";
          }else {
            $producto->p_mayoreo=$producto->p_mayoreo.".00";
          }
      }
      $pdf->Cell(40,6,utf8_decode("$".$producto->p_mayoreo),0,"Cell",'R');
      //totales
