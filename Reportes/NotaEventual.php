...
//////////////////////////////////////////////////CABECERA DE LA NOTA///////////////////////////////////////////////////
  ...
  $pdf->SetXY(70,42);
  $pdf->Cell(90,6,utf8_decode($venta->obs),0,0,'L');
  $pdf->SetXY(174,36.5);
...
foreach($_SESSION["carrito"] as $indice => $producto){
      ...
      //precio parcial
      $caracter="$producto->p_eventual";
      if (substr($producto->p_eventual, -3)==".00") {

      }else {

          if (substr($caracter, -2)==".5"){
            $producto->p_eventual=$producto->p_eventual."0";
          }else {
            $producto->p_eventual=$producto->p_eventual.".00";
          }
      }
      $pdf->Cell(40,6,utf8_decode("$".$producto->p_eventual),0,"Cell",'R');
      //totales
