<?php include_once "encabezadoVentas.php" ?>
<?php
  ...
  if (hora()==0) {
	...
	<div class="col-xs-12">
		...
		<div>
			...
			<a class="btn btn-danger" href="../../Reportes/NotaEventual.php">MOSTRAR NOTA PARA IMPRIMIR</a>
			...
			<a class="btn btn-success" href="./redireccionar.php">Elegir Nuevo Cliente</a>
		</div>
		<br>
