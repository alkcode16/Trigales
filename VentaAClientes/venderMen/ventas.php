...
function ejecutar(){
    ...
    <br>
		<div>
      <a class="btn btn-danger" href="../../Reportes/NotaMenudeo.php">MOSTRAR NOTA PARA IMPRIMIR</a>
      ...
      <a class="btn btn-success" href="./redireccionar.php">Seleccione Nuevo cliente</a>
